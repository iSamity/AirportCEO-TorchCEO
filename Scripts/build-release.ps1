...
<#
.SYNOPSIS
    Build the TorchCEO solution or specific projects in Release configuration.
...
.EXAMPLE
    ./build-release.ps1 -Project TorchCEO
    Builds only the TorchCEO project in Release configuration.
...
Write-Host "Building TorchCEO (Release)" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
